...
minetest.register_node("travelnet:elevator_door_steel_open", {
		...
		tiles = {"travelnet_steel_door.png"},
		paramtype = "light",
		paramtype2 = "facedir",
...
minetest.register_node("travelnet:elevator_door_stone_open", {
		description = "elevator door (open)",
		drawtype = "nodebox",
                -- top, bottom, side1, side2, inner, outer
		...
		drop = "travelnet:elevator_door_stone_closed",
                on_rightclick = function(pos, node, puncher)
                    minetest.add_node(pos, {name = "travelnet:elevator_door_stone_closed", param2 = node.param2})
                end,
})

minetest.register_node("travelnet:elevator_door_stone_closed", {
		description = "elevator door (closed)",
		drawtype = "nodebox",
                -- top, bottom, side1, side2, inner, outer
		tiles = {"default_stone.png"},
		...
		selection_box = {
			...
			fixed = {
                ...
                on_rightclick = function(pos, node, puncher)
                    minetest.add_node(pos, {name = "travelnet:elevator_door_stone_open", param2 = node.param2})
                end,
})
...
minetest.register_craft({
	        output = "travelnet:elevator_door_stone_closed",
	        recipe = {
